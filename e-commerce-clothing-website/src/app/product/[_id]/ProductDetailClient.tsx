// ./src/app/product/[_id]/ProductDetailClient.tsx
    ...
    <>
      <div className="min-h-screen">
        <div className="flex justify-center p-4">
          <div className="flex flex-wrap md:flex-nowrap justify-between md:justify-evenly mt-10 w-screen lg:w-9/12 2xl:w-6/12">
              ...
              <div>
                ...
                <div className="flex gap-5">
                  {['XS', 'S', 'M', 'L', 'XL'].map((size) => (
                    <div key={size} className="hover:shadow-lg px-3 cursor-pointer select-none py-2 box-border hover:rounded-full flex justify-center items-center font-bold text-neutral-700">
                      {size}
                    </div>
                  ))}
                </div>
